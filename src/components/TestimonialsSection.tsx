...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      image: nina,
      rating: 5,
      text: 'Contivibe media is reliable, they give the client an unforgetable experience...they do variety of takes to your satisfaction...I will always choose Contivibe media..',
    },
    {
      name: 'Jovan Lule',
    ...
    <section className="section-padding bg-gradient-to-b from-muted/50 to-background">
      <div className="container-custom">
        ...
        <div className="relative">
          ...
          <div className="max-w-4xl mx-auto transition-all duration-900 ease-in-out opacity-100 transform animate-fade-in">
            <Card className="border-0 shadow-2xl bg-card/50 backdrop-blur-sm">
              <CardContent className="p-8 md:p-12">
                <div className="text-center">
                  ...
                  {/* Testimonial Text */}
                  <blockquote className="text-sm md:text-1xl leading-relaxed mb-8 italic text-foreground font-light">
