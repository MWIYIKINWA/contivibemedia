  ...
  if (!post) {
    return (
      <div className="min-h-screen">
        ...
        <WhatsAppChat />
        <ScrollToTop />
        <div className="container-custom py-20 text-center my-20">
          <h1 className="text-2xl font-bold mb-4">Article</h1>
          <p className="text-muted-foreground mb-6">
            ARTICLE LOADING...
          </p>
          <Button asChild>
            <Link to="/store-news">Back to News</Link>
          </Button>
        </div>
        <Footer />
      </div>
      ...
      <main>
        ...
        <div className="py-4 bg-primary text-white flex justify-between font-roboto">
          ...
          <div className="flex mr-10 space-x-2">
            ...
            <h6>{new Date(post.created_at).toISOString().slice(0, 10)}</h6>
          </div>
        </div>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mb-8">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <small className="font-sans">{post.read_time} min read</small>
                </div>
              </div>
              ...
              <div className="prose max-w-none">
                <div
                  className="text-lg text-foreground mb-6 leading-relaxed text-sm text-justify"
