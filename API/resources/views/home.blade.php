...
<div class="container">
    <div class="row ">
       ...
       @if(auth()->user()->role === 'admin')
        <div class="col-xl-4 col-lg-4 mt-3">
            <a href="{{route('adminuser')}}" style="text-decoration: none">
            <div class="card ">
                <div class="card-statistic-3 p-4">
                    <div class="card-icon card-icon-large"><i class="fas fa-ticket-alt"></i></div>
                    <div class="mb-4">
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-7 d-flex">
                            ...
                            <span class="mt-1 mx-2">Active</span>
                        </div>
                        <div class="col-5 text-right">
                            <span>Manage <i class="fa fa-arrow-right"></i></span>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 mt-3">
            <a href={{route('pdf-document.index')}} style="" class="btn btn-danger">
                Update Portfolio PDF
            </a>
            <a href="{{route('flyer.index')}}" style="" class="btn btn-dark mt-1">
